...
function Cookies() {
  return (
<div className="fixed bottom-0 inset-x-0 z-50 overflow-hidden bg-white">
  <div className="relative container px-4 mx-auto">
    <img
      className="absolute bottom-0 right-0 lg:left-0"
      src="saturn-assets/images/cookies/cookies-big.svg"
      alt=""
    />
    <div className="relative py-10 max-w-4xl mx-auto">
      <div className="flex flex-wrap -mx-4 items-center">
        <div className="w-full lg:w-2/3 px-4 mb-8 lg:mb-0">
          <div className="lg:ml-auto xl:ml-0 max-w-md">
            <p className="text-gray-500 mb-3">
              By clicking "Accept all cookies" you consent to cookies being
              stored on your device to improve website.
            </p>
            <a
        ...
        <div className="w-full lg:w-1/3 px-4">
          <div className="flex items-center lg:justify-end">
            <a
              className="inline-block mr-4 py-3 px-5 text-sm font-semibold text-[#ff460c] border border-gray-200 rounded-md hover:border-[#ff460c] transition duration-200"
              href="#"
            >
              Decline
            </a>
            <a
              className="inline-block py-3 px-5 text-sm font-semibold text-orange-50 bg-[#ff460c] hover:bg-gray-900 rounded-md transition duration-200"
              href="#"
            >
              Accept all cokies
            </a>
