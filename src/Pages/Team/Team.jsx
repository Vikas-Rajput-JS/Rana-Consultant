...
<section className="relative py-20 md:py-24 overflow-hidden">
  <img
    ...
    src="https://shuffle.dev/saturn-assets/images/team/light-blue.png"
    alt=""
  />
  <img
    className="absolute bottom-0 right-0 mr-32"
    src="https://shuffle.dev/saturn-assets/images/team/light-orange.png"
    alt=""
  />
        ...
        <div className="w-full xl:w-1/2 px-4">
          <div className="max-w-md xl:ml-auto">
            <p className="text-lg text-gray-500 mb-6">
              Mi turpis turpis in justo pellentesque id nibh praesent. Posuere
              vel sit dignissim eu nisl.
            </p>
            <a
      ...
      <div className="flex flex-wrap -mx-4 -mb-12">
        <div className="w-full md:w-1/2 xl:w-1/4 px-4 mb-12">
          <div className="max-w-xs md:max-w-none mx-auto">
            <img
              ...
              src="https://shuffle.dev/saturn-assets/images/team/photo-team-men1.png"
              alt=""
            />
        ...
        <div className="w-full md:w-1/2 xl:w-1/4 px-4 mb-12">
          <div className="max-w-xs md:max-w-none mx-auto">
            <img
              className="block mb-4 w-full h-72 object-cover rounded-3xl"
              src="https://shuffle.dev/saturn-assets/images/team/photo-team-men2.png"
              alt=""
            />
            <h5 className="text-2xl font-semibold text-gray-900 mb-2">
              Jake Aduhai
        ...
        <div className="w-full md:w-1/2 xl:w-1/4 px-4 mb-12">
          <div className="max-w-xs md:max-w-none mx-auto">
            <img
              className="block mb-4 w-full h-72 object-cover rounded-3xl"
              src="https://shuffle.dev/saturn-assets/images/team/photo-team-men3.png"
              alt=""
            />
            <h5 className="text-2xl font-semibold text-gray-900 mb-2">
              Azalea Perumahan
        ...
        <div className="w-full md:w-1/2 xl:w-1/4 px-4 mb-12">
          <div className="max-w-xs md:max-w-none mx-auto">
            <img
              className="block mb-4 w-full h-72 object-cover rounded-3xl"
              src="https://shuffle.dev/saturn-assets/images/team/photo-team-men4.png"
              alt=""
            />
            <h5 className="text-2xl font-semibold text-gray-900 mb-2">
              Gatot Bambang
