          ...
          <div className="pb-16 mb-14 border-b border-gray-200 border-opacity-30">
            ...
            <div className="md:ml-16">
              <label className="relative flex mb-8 items-center">
                ...
                />
                <button
                  className="absolute top-1/2 left-0 transform -translate-y-1/2 h-6 w-6"
                  fdprocessedid="xzfw0h"
                >
                  <svg
                    width={27}
                    height={27}
            ...
            <div className="flex flex-wrap mb-6 items-center">
              ...
              <div className="w-full md:w-2/3">
                <input
                  className="w-full px-5 py-3 text-lg leading-9 bg-blue-50 border-2 border-blue-400 outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl"
                  type="text"
                  fdprocessedid="s8yqzd"
                />
              </div>
            </div>
            <div className="flex flex-wrap items-center">
              <div className="w-full md:w-1/3 mb-2 md:mb-0 md:pr-10 md:text-right">
                <label className="text-lg text-darkBlueGray-400">CVV:</label>
              </div>
              <div className="w-full md:w-1/3">
                <input
                  className="w-full px-5 py-3 text-lg leading-9 bg-blue-50 border-2 border-blue-400 outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl"
                  type="text"
                  fdprocessedid="007mkg"
                />
              </div>
            </div>
          </div>
      ...
      <div className="w-full md:w-4/12 lg:w-1/4 px-4">
        <div>
          ...
          <div className="relative mb-3 lg:mb-10">
            ...
            />
            <a
              className="absolute top-1/2 transform -translate-y-1/2 right-1 -translate-x-px w-auto xl:w-auto py-3 px-8 text-lg leading-7 text-white font-medium tracking-tighter font-heading text-center bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl"
              href="#"
            >
              Apply
            </a>
