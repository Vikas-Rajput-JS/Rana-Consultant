              ...
              <div className="flex flex-wrap items-center justify-between -m-2">
                ...
                <div className="w-auto p-2">
                  <div className="flex h-full items-center">
                    <img
                      className="w-7 h-7 rounded-full object-cover"
                      src="trizzle-assets/images/avatar-women-2-circle-border.png"
                      alt=""
                    />
                    <img
                      className="w-7 h-7 -ml-3 rounded-full object-cover"
                      src="trizzle-assets/images/avatar-women-3-circle-border.png"
                      alt=""
                    />
                  </div>
                </div>
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
        <div className="max-w-sm mx-auto h-full px-4 pt-6 pb-24 bg-gray-500 rounded-xl">
          ...
          >
            <img
              className="block w-full h-28 object-cover rounded-md mb-3"
              src="trizzle-assets/images/working-women-laptop.png"
              alt=""
            />
            <h4 className="text-white font-semibold leading-6 mb-1">
