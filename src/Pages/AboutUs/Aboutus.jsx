    ...
    <div className="flex flex-wrap mb-32 -mx-4">
      <div className="w-full lg:w-1/2 p-4">
        <p className="text-gray-600 text-lg">
          ...
          every educational experience with the essence of joy.
        </p>
      </div>
      <div className="w-full lg:w-1/2 p-4">
        <p className="text-gray-600 text-lg">
      ...
      <div className="w-full lg:w-1/3 p-4">
        <div
          ...
          style={{
            height: 440,
            backgroundImage:
              'url("https://shuffle.dev/solstice-assets/images/about/men-picture.png")'
          }}
        >
      ...
      <div className="w-full lg:w-1/3 p-4">
        <div
          ...
          style={{
            height: 440,
            backgroundImage:
              'url("https://shuffle.dev/solstice-assets/images/about/woman-picture1.png")'
          }}
        >
          <div className="absolute bottom-0 left-0 bg-white rounded-tr-3xl rounded-bl-3xl px-6 py-3">
      ...
      <div className="w-full lg:w-1/3 p-4">
        <div
          ...
          style={{
            height: 440,
            backgroundImage:
              'url("https://shuffle.dev/solstice-assets/images/about/woman-picture2.png")'
          }}
        >
          <div className="absolute bottom-0 left-0 bg-white rounded-tr-3xl rounded-bl-3xl px-6 py-3">
            <h2 className="text-2xl font-bold font-heading mb-2">
  ...
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap justify-center">
      <div className="w-auto">
        <img src="https://shuffle.dev/flaro-assets/logos/brands/logo-square-white.png" alt="" />
      </div>
      <div className="w-auto">
        <img src="https://shuffle.dev/flaro-assets/logos/brands/logo-square-white2.png" alt="" />
      </div>
      <div className="w-auto">
        <img src="https://shuffle.dev/flaro-assets/logos/brands/logo-square-white3.png" alt="" />
      </div>
      <div className="w-auto">
        <img src="https://shuffle.dev/flaro-assets/logos/brands/logo-square-white4.png" alt="" />
      </div>
      <div className="w-auto">
        <img src="https://shuffle.dev/flaro-assets/logos/brands/logo-square-white5.png" alt="" />
      </div>
      <div className="w-auto">
        <img src="https://shuffle.dev/flaro-assets/logos/brands/logo-square-white6.png" alt="" />
      </div>
    </div>
